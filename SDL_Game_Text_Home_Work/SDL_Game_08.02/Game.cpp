...
bool Game::ttf_init() {
	...
	TTF_Font* font1 = TTF_OpenFont("fonts/comic.ttf", 48);
	TTF_Font* font2 = TTF_OpenFont("fonts/comici.ttf", 72);
	...
	//за да рендирате първия текст от ляво на екрана
	...
	//за да рендирате втория текст от ляво на екрана
	...
	//за да рендирате първия текст от дясно на екрана
	...
	//за да рендирате втория текст от дясно на екрана
	...
	//за да рендирате  текста в средата на екрана
...
void Game::handleEvents() {  // добавяне на интеракций
	...
	if (SDL_PollEvent(&event)) {
		...
		case SDL_MOUSEMOTION: {
			...
			//единия текст(dRectFont2) се движи с мишката
			std::cout << event.motion.x << ":" << event.motion.y << std::endl;
			//dRectFont2.x = event.motion.x - dRectFont2.w / 2;
			//dRectFont2.y = event.motion.y - dRectFont2.y / 2;
