	...
	if (SDL_Init(SDL_INIT_EVERYTHING) == 0) {
		...
		if (window != 0) //window init success
		{
			...
			if (renderer != 0) //renderer init success
			{
				...
				TextureManager::Instance()->loadTexture("assets/black.jpg", "jpg", renderer);
				TextureManager::Instance()->loadTexture("assets/cards.gif", "sprite_sheet", renderer);
...
void Game::render() {
	...
	//SDL_SetRenderDrawColor(renderer, 0, 115, 0, 255); // sets the window bg color needs to sit before SDL_RenderClear()
